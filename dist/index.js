...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const wordAanalysisResult = (0, utils_1.wordCounter)(textFromDirectoryFiles, +numberOfMostFrequentlyOccurringWords);
        (0, utils_1.formatAndPrintReport)(wordAanalysisResult);
    }
    catch (e) {
        console.log(e);
    }
